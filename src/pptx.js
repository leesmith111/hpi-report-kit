...
// ============================================================================
// Competitive-set slides (from competitiveSetDeck.js)
// ============================================================================
...
const SUPPLY_HEAD = ['Building', 'Submarket', 'Total SF', 'Available', 'Gen', 'Status', 'Asking $/SF', 'Owner'];
...
const SUPPLY_COLW = [2.7, 1.3, 1.0, 1.0, 0.95, 1.3, 1.15, 2.83];
const COMPS_COLW = [2.8, 2.6, 3.2, 1.1, 1.1, 1.43];
